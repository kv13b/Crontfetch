...
func TestDetectPlatform(t *testing.T) {
	tests := []struct {
		...
		{"https://jobs.lever.co/spotify", PlatformLever, "spotify"},
		{"https://jobs.lever.co/spotify/2193db3f-77c5", PlatformLever, "spotify"},
		{"https://jobs.ashbyhq.com/linear", PlatformAshby, "linear"},
		{"https://jobs.smartrecruiters.com/BoschGroup", PlatformSmartRecruiters, "BoschGroup"},
		{"https://careers.smartrecruiters.com/BoschGroup/", PlatformSmartRecruiters, "BoschGroup"},
		{"https://apply.workable.com/huggingface/", PlatformWorkable, "huggingface"},
		{"https://bunq.recruitee.com/", PlatformRecruitee, "bunq"},
		{"https://www.recruitee.com/", "", ""},
		{"https://jobs.lever.co/", PlatformLever, ""},
